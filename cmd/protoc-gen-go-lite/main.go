...
import (
	...
	gengo "github.com/aperturerobotics/protobuf-go-lite/cmd/protoc-gen-go-lite/internal_gengo"
...
func main() {
	...
	protogen.Options{
		...
		if *plugins != "" {
			return errors.New("protoc-gen-go-lite: plugins are not supported; use 'protoc --go-grpc_out=...' to generate gRPC\n\n" +
