...
func (x *MessageWithWKTs) MarshalProtoJSON(s *jsonplugin.MarshalState) {
	...
	if x.EmptyValue != nil || s.HasField("empty_value") {
		...
		if x.EmptyValue == nil {
			...
			golang.MarshalEmpty(s, x.EmptyValue)
		}
	}
	...
	if x.TimestampValue != nil || s.HasField("timestamp_value") {
		...
		if x.TimestampValue == nil {
			...
			golang.MarshalTimestamp(s, x.TimestampValue)
		}
	}
	if len(x.TimestampValues) > 0 || s.HasField("timestamp_values") {
		...
		for _, element := range x.TimestampValues {
			...
			if element == nil {
				...
				golang.MarshalTimestamp(s, element)
			}
		}
		s.WriteArrayEnd()
	}
	if x.DurationValue != nil || s.HasField("duration_value") {
		...
		if x.DurationValue == nil {
			...
			golang.MarshalDuration(s, x.DurationValue)
		}
	}
	if len(x.DurationValues) > 0 || s.HasField("duration_values") {
		...
		for _, element := range x.DurationValues {
			...
			if element == nil {
				...
				golang.MarshalDuration(s, element)
			}
		}
		s.WriteArrayEnd()
	}
	if x.FieldMaskValue != nil || s.HasField("field_mask_value") {
		...
		if x.FieldMaskValue == nil {
			...
			golang.MarshalFieldMask(s, x.FieldMaskValue)
		}
	}
	if len(x.FieldMaskValues) > 0 || s.HasField("field_mask_values") {
		...
		for _, element := range x.FieldMaskValues {
			...
			if element == nil {
				...
				golang.MarshalFieldMask(s, element)
			}
		}
		s.WriteArrayEnd()
	}
	if x.ValueValue != nil || s.HasField("value_value") {
		...
		if x.ValueValue == nil {
			...
			golang.MarshalValue(s, x.ValueValue)
		}
	}
	...
	if x.ListValueValue != nil || s.HasField("list_value_value") {
		...
		if x.ListValueValue == nil {
			...
			golang.MarshalListValue(s, x.ListValueValue)
		}
	}
	if len(x.ListValueValues) > 0 || s.HasField("list_value_values") {
		...
		for _, element := range x.ListValueValues {
			...
			if element == nil {
				...
				golang.MarshalListValue(s, element)
			}
		}
		s.WriteArrayEnd()
	}
	if x.StructValue != nil || s.HasField("struct_value") {
		...
		if x.StructValue == nil {
			...
			golang.MarshalStruct(s, x.StructValue)
		}
	}
	...
	s.ReadObject(func(key string) {
		...
		case "double_values", "doubleValues":
			...
			s.ReadArray(func() {
				...
				x.DoubleValues = append(x.DoubleValues, &wrapperspb.DoubleValue{Value: v})
			})
		...
		case "float_values", "floatValues":
			...
			s.ReadArray(func() {
				...
				x.FloatValues = append(x.FloatValues, &wrapperspb.FloatValue{Value: v})
			})
		...
		case "int32_values", "int32Values":
			...
			s.ReadArray(func() {
				...
				x.Int32Values = append(x.Int32Values, &wrapperspb.Int32Value{Value: v})
			})
		...
		case "int64_values", "int64Values":
			...
			s.ReadArray(func() {
				...
				x.Int64Values = append(x.Int64Values, &wrapperspb.Int64Value{Value: v})
			})
		...
		case "uint32_values", "uint32Values":
			...
			s.ReadArray(func() {
				...
				x.Uint32Values = append(x.Uint32Values, &wrapperspb.UInt32Value{Value: v})
			})
		...
		case "uint64_values", "uint64Values":
			...
			s.ReadArray(func() {
				...
				x.Uint64Values = append(x.Uint64Values, &wrapperspb.UInt64Value{Value: v})
			})
		...
		case "bool_values", "boolValues":
			...
			s.ReadArray(func() {
				...
				x.BoolValues = append(x.BoolValues, &wrapperspb.BoolValue{Value: v})
			})
		...
		case "string_values", "stringValues":
			...
			s.ReadArray(func() {
				...
				x.StringValues = append(x.StringValues, &wrapperspb.StringValue{Value: v})
			})
		...
		case "bytes_values", "bytesValues":
			...
			s.ReadArray(func() {
				...
				x.BytesValues = append(x.BytesValues, &wrapperspb.BytesValue{Value: v})
			})
	...
	if x.Value != nil {
		...
		case *MessageWithOneofWKTs_EmptyValue:
			...
			if ov.EmptyValue == nil {
				...
				golang.MarshalEmpty(s, ov.EmptyValue)
			}
		case *MessageWithOneofWKTs_TimestampValue:
			...
			if ov.TimestampValue == nil {
				...
				golang.MarshalTimestamp(s, ov.TimestampValue)
			}
		case *MessageWithOneofWKTs_DurationValue:
			...
			if ov.DurationValue == nil {
				...
				golang.MarshalDuration(s, ov.DurationValue)
			}
		case *MessageWithOneofWKTs_FieldMaskValue:
			...
			if ov.FieldMaskValue == nil {
				...
				golang.MarshalFieldMask(s, ov.FieldMaskValue)
			}
		case *MessageWithOneofWKTs_ValueValue:
			...
			if ov.ValueValue == nil {
				...
				golang.MarshalValue(s, ov.ValueValue)
			}
		case *MessageWithOneofWKTs_ListValueValue:
			...
			if ov.ListValueValue == nil {
				...
				golang.MarshalListValue(s, ov.ListValueValue)
			}
		case *MessageWithOneofWKTs_StructValue:
			...
			if ov.StructValue == nil {
				...
				golang.MarshalStruct(s, ov.StructValue)
			}
		...
		case "string_double_map", "stringDoubleMap":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringDoubleMap[key] = &wrapperspb.DoubleValue{Value: v}
				}
			})
		case "string_float_map", "stringFloatMap":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringFloatMap[key] = &wrapperspb.FloatValue{Value: v}
				}
			})
		case "string_int32_map", "stringInt32Map":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringInt32Map[key] = &wrapperspb.Int32Value{Value: v}
				}
			})
		case "string_int64_map", "stringInt64Map":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringInt64Map[key] = &wrapperspb.Int64Value{Value: v}
				}
			})
		case "string_uint32_map", "stringUint32Map":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringUint32Map[key] = &wrapperspb.UInt32Value{Value: v}
				}
			})
		case "string_uint64_map", "stringUint64Map":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringUint64Map[key] = &wrapperspb.UInt64Value{Value: v}
				}
			})
		case "string_bool_map", "stringBoolMap":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringBoolMap[key] = &wrapperspb.BoolValue{Value: v}
				}
			})
		case "string_string_map", "stringStringMap":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringStringMap[key] = &wrapperspb.StringValue{Value: v}
				}
			})
		case "string_bytes_map", "stringBytesMap":
			...
			s.ReadStringMap(func(key string) {
				if s.ReadNil() {
					...
					x.StringBytesMap[key] = &wrapperspb.BytesValue{Value: v}
				}
			})
