...
func (m *BasicMsg) CloneVT() *BasicMsg {
	...
	r.BytesField = protobuf_go_lite.CloneBytes(m.BytesField)
	r.RepeatedInt32Field = protobuf_go_lite.CloneSlice(m.RepeatedInt32Field)
	r.MapStringInt32Field = protobuf_go_lite.CloneMap(m.MapStringInt32Field)
	if m.MyOneof != nil {
...
func (this *BasicMsg) EqualVT(that *BasicMsg) bool {
	...
	if !protobuf_go_lite.EqualBytes(this.BytesField, that.BytesField) {
		return false
	}
	if !protobuf_go_lite.EqualSlice(this.RepeatedInt32Field, that.RepeatedInt32Field) {
		return false
	}
	if !protobuf_go_lite.EqualMap(this.MapStringInt32Field, that.MapStringInt32Field) {
		return false
	}
...
func (m *BasicMsg_NestedMsg) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.NestedString) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.NestedString)
		i--
		dAtA[i] = 0x12
	}
	if m.NestedInt32 != 0 {
...
func (m *BasicMsg) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RepeatedInt32Field) > 0 {
		i = protobuf_go_lite.EncodeVarintPacked(dAtA, i, m.RepeatedInt32Field)
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	...
	if len(m.BytesField) > 0 {
		i = protobuf_go_lite.EncodeBytes(dAtA, i, m.BytesField)
		i--
		dAtA[i] = 0x7a
	}
	if len(m.StringField) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.StringField)
		i--
		dAtA[i] = 0x72
	}
	if m.BoolField {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.BoolField)
		i--
		dAtA[i] = 0x68
	}
	if m.DoubleField != 0 {
		i = protobuf_go_lite.EncodeFixed64(dAtA, i, uint64(math.Float64bits(float64(m.DoubleField))))
		i--
		dAtA[i] = 0x61
	}
	if m.FloatField != 0 {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(m.FloatField))))
		i--
		dAtA[i] = 0x5d
	}
	if m.Sfixed64Field != 0 {
		i = protobuf_go_lite.EncodeFixed64(dAtA, i, uint64(m.Sfixed64Field))
		i--
		dAtA[i] = 0x51
	}
	if m.Sfixed32Field != 0 {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(m.Sfixed32Field))
		i--
		dAtA[i] = 0x4d
	}
	if m.Fixed64Field != 0 {
		i = protobuf_go_lite.EncodeFixed64(dAtA, i, uint64(m.Fixed64Field))
		i--
		dAtA[i] = 0x41
	}
	if m.Fixed32Field != 0 {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(m.Fixed32Field))
		i--
		dAtA[i] = 0x3d
	}
	if m.Sint64Field != 0 {
		i = protobuf_go_lite.EncodeZigzag64(dAtA, i, m.Sint64Field)
		i--
		dAtA[i] = 0x30
	}
	if m.Sint32Field != 0 {
		i = protobuf_go_lite.EncodeZigzag32(dAtA, i, m.Sint32Field)
		i--
		dAtA[i] = 0x28
	}
	if m.Uint64Field != 0 {
...
func (m *BasicMsg_OneofString) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protobuf_go_lite.EncodeString(dAtA, i, m.OneofString)
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x92
...
func (m *BasicMsg_NestedMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.NestedInt32)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.NestedString)
...
func (m *BasicMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Int32Field)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Int64Field)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Uint32Field)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Uint64Field)
	n += protobuf_go_lite.SizeZigzagNonZero(1, m.Sint32Field)
	n += protobuf_go_lite.SizeZigzagNonZero(1, m.Sint64Field)
	n += protobuf_go_lite.SizeFixed32NonZero(1, m.Fixed32Field)
	n += protobuf_go_lite.SizeFixed64NonZero(1, m.Fixed64Field)
	n += protobuf_go_lite.SizeFixed32NonZero(1, m.Sfixed32Field)
	n += protobuf_go_lite.SizeFixed64NonZero(1, m.Sfixed64Field)
	n += protobuf_go_lite.SizeFixed32NonZero(1, m.FloatField)
	n += protobuf_go_lite.SizeFixed64NonZero(1, m.DoubleField)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.BoolField)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.StringField)
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.BytesField)
	n += protobuf_go_lite.SizeVarintPacked(2, m.RepeatedInt32Field)
	...
	n += protobuf_go_lite.SizeVarintNonZero(2, m.EnumField)
	if m.NestedMessage != nil {
...
func (m *BasicMsg_OneofString) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringValue(2, m.OneofString)
	return n
}
func (m *BasicMsg_OneofInt32) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintValue(2, m.OneofInt32)
	return n
}
...
func (x *BasicMsg_MapStringInt32FieldEntry) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MapStringInt32FieldEntry")
	if x.Key != "" {
...
func (x *BasicMsg_NestedMsg) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "NestedMsg")
	if x.NestedInt32 != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "nested_int32")
		protobuf_go_lite.TextWriteInt(&sb, x.NestedInt32)
	}
	if x.NestedString != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "nested_string")
		protobuf_go_lite.TextWriteString(&sb, x.NestedString)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *BasicMsg) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BasicMsg")
	if x.Int32Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "int32_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Int32Field)
	}
	if x.Int64Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "int64_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Int64Field)
	}
	if x.Uint32Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "uint32_field")
		protobuf_go_lite.TextWriteUint(&sb, x.Uint32Field)
	}
	if x.Uint64Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "uint64_field")
		protobuf_go_lite.TextWriteUint(&sb, x.Uint64Field)
	}
	if x.Sint32Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sint32_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Sint32Field)
	}
	if x.Sint64Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sint64_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Sint64Field)
	}
	if x.Fixed32Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "fixed32_field")
		protobuf_go_lite.TextWriteUint(&sb, x.Fixed32Field)
	}
	if x.Fixed64Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "fixed64_field")
		protobuf_go_lite.TextWriteUint(&sb, x.Fixed64Field)
	}
	if x.Sfixed32Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sfixed32_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Sfixed32Field)
	}
	if x.Sfixed64Field != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sfixed64_field")
		protobuf_go_lite.TextWriteInt(&sb, x.Sfixed64Field)
	}
	if x.FloatField != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "float_field")
		protobuf_go_lite.TextWriteFloat32(&sb, x.FloatField)
	}
	if x.DoubleField != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "double_field")
		protobuf_go_lite.TextWriteFloat64(&sb, x.DoubleField)
	}
	if x.BoolField != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "bool_field")
		protobuf_go_lite.TextWriteBool(&sb, x.BoolField)
	}
	if x.StringField != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "string_field")
		protobuf_go_lite.TextWriteString(&sb, x.StringField)
	}
	if len(x.BytesField) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "bytes_field")
		protobuf_go_lite.TextWriteBytes(&sb, x.BytesField)
	}
	if len(x.RepeatedInt32Field) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "repeated_int32_field")
	...
	case *BasicMsg_OneofString:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "oneof_string")
		protobuf_go_lite.TextWriteString(&sb, body.OneofString)
	case *BasicMsg_OneofInt32:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "oneof_int32")
		protobuf_go_lite.TextWriteInt(&sb, body.OneofInt32)
	}
	if x.EnumField != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "enum_field")
		protobuf_go_lite.TextWriteStringer(&sb, BasicMsg_MyEnum(x.EnumField))
	}
...
func (m *BasicMsg_NestedMsg) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.NestedInt32 = 0
			m.NestedInt32, iNdEx, err = protobuf_go_lite.DecodeVarintInt32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 2:
...
func (m *BasicMsg) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Int32Field = 0
			m.Int32Field, iNdEx, err = protobuf_go_lite.DecodeVarintInt32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 2:
			...
			m.Int64Field = 0
			m.Int64Field, iNdEx, err = protobuf_go_lite.DecodeVarintInt64(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 3:
			...
			m.Uint32Field = 0
			m.Uint32Field, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 4:
			...
			m.Uint64Field = 0
			m.Uint64Field, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 5:
		...
		case 15:
			...
			m.BytesField, iNdEx, err = protobuf_go_lite.DecodeBytesAppend(m.BytesField, dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 16:
		...
		case 18:
			...
			m.MyOneof = &BasicMsg_OneofString{OneofString: v}
		case 19:
			if wireType != 0 {
		...
		case 20:
			...
			m.EnumField = BasicMsg_MyEnum(_v)
			if err != nil {
				return err
			}
		case 21:
...
func (m *BasicMsg) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			...
			m.BytesField, iNdEx, err = protobuf_go_lite.DecodeBytes(dAtA, iNdEx, false)
			if err != nil {
				return err
			}
		case 16:
