...
// @generated from file github.com/aperturerobotics/protobuf-go-lite/types/pluginpb/plugin.proto (package google.protobuf.compiler, syntax proto2)
/* eslint-disable */
...
import { FileDescriptorProto, GeneratedCodeInfo } from "@aptre/protobuf-es-lite/google/protobuf/descriptor";
...
export const CodeGeneratorResponse_Feature_Enum = /* @__PURE__ */ createEnumType("google.protobuf.compiler.CodeGeneratorResponse.Feature", [
  [0, "FEATURE_NONE"],
...
export const CodeGeneratorRequest: MessageType<CodeGeneratorRequest> = /* @__PURE__ */ createMessageType({
    typeName: "google.protobuf.compiler.CodeGeneratorRequest",
    fields: [
        { no: 1, name: "file_to_generate", kind: "scalar", T: ScalarType.STRING, repeated: true },
        { no: 2, name: "parameter", kind: "scalar", T: ScalarType.STRING, opt: true },
...
export const CodeGeneratorResponse_File: MessageType<CodeGeneratorResponse_File> = /* @__PURE__ */ createMessageType({
    typeName: "google.protobuf.compiler.CodeGeneratorResponse.File",
    fields: [
        { no: 1, name: "name", kind: "scalar", T: ScalarType.STRING, opt: true },
        { no: 2, name: "insertion_point", kind: "scalar", T: ScalarType.STRING, opt: true },
        { no: 15, name: "content", kind: "scalar", T: ScalarType.STRING, opt: true },
...
export const CodeGeneratorResponse: MessageType<CodeGeneratorResponse> = /* @__PURE__ */ createMessageType({
    typeName: "google.protobuf.compiler.CodeGeneratorResponse",
    fields: [
        { no: 1, name: "error", kind: "scalar", T: ScalarType.STRING, opt: true },
        { no: 2, name: "supported_features", kind: "scalar", T: ScalarType.UINT64, opt: true },
        { no: 3, name: "minimum_edition", kind: "scalar", T: ScalarType.INT32, opt: true },
        { no: 4, name: "maximum_edition", kind: "scalar", T: ScalarType.INT32, opt: true },
